      ...
      <div className={cn("flex max-w-[82%] flex-col sm:max-w-[68%]", user && "items-end")}>
        <div
          className={cn(
            ...
            user
              ? "whitespace-pre-wrap rounded-[18px] rounded-br-[6px] bg-brand-ink text-brand-foreground"
              : "rounded-[18px] rounded-bl-[6px] bg-secondary text-foreground",
...
function StreamingBubble({ text }: { text: string }) {
  return (
    <div className="flex w-full justify-start">
      <div className="max-w-[82%] rounded-[18px] rounded-bl-[6px] bg-secondary px-3.5 py-2 text-[14.5px] leading-relaxed text-foreground sm:max-w-[68%]">
...
function TypingIndicator() {
  return (
    <div className="flex animate-rise-in justify-start">
      <div className="flex items-center gap-1 rounded-[18px] rounded-bl-[6px] bg-secondary px-3.5 py-3">
...
export function ChatView({ bot }: { bot: Bot }) {
  ...
  const [terminalHeight, setTerminalHeight] = useState(() => {
    const saved = Number(localStorage.getItem("workmates-terminal-height"));
            ...
            onPointerDown={(e) => {
              ...
              const up = () => {
                ...
                setTerminalHeight((height) => {
                  localStorage.setItem("workmates-terminal-height", String(height));
                  return height;
                });
              };
