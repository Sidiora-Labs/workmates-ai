        ...
        {status === "connected" ? (
          ...
          <div className="flex shrink-0 items-center gap-1">
            <button
              onClick={connect}
              disabled={busy}
              className="rounded-full bg-brand-ink px-3 py-1.5 text-[12.5px] font-semibold text-brand-foreground transition-opacity hover:opacity-90 disabled:opacity-60"
            >
              {busy ? (
