...
import { MateAvatar } from "@/components/agents/Avatar";
import { MATE_COLOR_NAMES, shapeForBot, type MateColor } from "@/lib/mascot";
...
function colorFor(name: string): MateColor {
  let hash = 0;
  for (let i = 0; i < name.length; i++) hash = (hash * 31 + name.charCodeAt(i)) | 0;
  return MATE_COLOR_NAMES[Math.abs(hash) % MATE_COLOR_NAMES.length];
}
