...
export function CloudSection() {
  ...
  const activate = () => {
    ...
    if (!CLOUD_KEY.test(trimmed)) {
      setError("That is not a Workmates Cloud key. One starts with wm_live_ and ends in 32 hex characters.");
      return;
    }
    setBusy(true);
    setError(null);
      ...
      <div className="flex items-start justify-between gap-3">
        <div className="min-w-0">
          <div className="flex items-center gap-1.5">
            ...
            <span className="text-[13.5px] font-semibold text-foreground">Workmates Cloud</span>
          </div>
      ...
      {status === null ? (
        ...
        <div className="mt-3 text-[12px] leading-relaxed text-muted-foreground">
          ...
          <div className="mt-2 flex gap-2">
            <Input
              ...
              aria-label="Workmates Cloud key"
              spellCheck={false}
              autoComplete="off"
        ...
        <div className="mt-3">
          ...
          <div className="mt-2.5 flex items-center gap-2.5">
            <a
              href="https://workmate.centra.ag/cloud"
              target="_blank"
              rel="noreferrer"
