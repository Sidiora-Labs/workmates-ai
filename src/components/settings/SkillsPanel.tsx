...
export function SkillsPanel() {
  ...
  return (
    ...
    >
      <div
        className="flex h-[76%] w-[560px] max-w-[92vw] animate-pop-in flex-col rounded-[14px] bg-popover/90 p-4 shadow-[0_24px_64px_-12px_var(--shadow-color),0_0_0_0.5px_var(--border),0_0_0_1px_var(--shadow-color)] backdrop-blur-2xl backdrop-saturate-150 sm:p-5"
          ...
          {!adding && tab === "catalog" ? (
            ...
            <>
              ...
              <div className="mt-2.5 text-[11.5px] leading-relaxed text-muted-foreground">
                ...
                <code className="rounded bg-muted px-1 py-px font-mono">~/.workmates/skills</code>.
              </div>
            </>
          )}
        </div>
