...
export function PluginsPanel() {
  ...
  const introPicks = useMemo(() => {
    try {
      return new Set<string>(JSON.parse(localStorage.getItem("workmates-intro-plugins") ?? "[]"));
    } catch {
  ...
  return (
    ...
    >
      <div
        className={cn(
          "flex max-h-[80%] animate-pop-in flex-col rounded-[14px] bg-popover/90 p-5 shadow-[0_24px_64px_-12px_var(--shadow-color),0_0_0_0.5px_var(--border),0_0_0_1px_var(--shadow-color)] backdrop-blur-2xl backdrop-saturate-150 transition-[width] duration-200",
      ...
      >
        ...
        <div className="mt-0.5 text-[13px] text-muted-foreground">
          {view === "connectors"
            ...
            : "Interfaces your own MCP servers draw, framed inside Workmates."}
        </div>
