...
function paletteNow(dark: boolean) {
  ...
  return {
    ...
    background: token("--card", dark ? "#232326" : "#ffffff"),
    foreground: token("--foreground", dark ? "#f2f2f5" : "#1d1d1f"),
    muted: token("--muted-foreground", dark ? "#a1a1aa" : "#66666e"),
    border: token("--border", dark ? "#3a3a40" : "#e6e6e9"),
...
export function McpAppsCard() {
  ...
  if (!servers) {
    return (
      <div className="mt-4 flex items-center gap-2 rounded-[10px] border bg-card p-4 text-[12.5px] text-muted-foreground">
  ...
  return (
    <div className="mt-4 rounded-[10px] border bg-card p-4">
      ...
      <div className="mt-0.5 text-[12.5px] leading-relaxed text-muted-foreground">
        ...
        framed with no network of their own and no way to read anything in Workmates.
      </div>
      {servers.length === 0 ? (
  ...
  return (
    <div className="mt-4 flex flex-col overflow-hidden rounded-2xl border bg-card">
      ...
      <div className="flex items-start gap-2 border-t px-3 py-2 text-[11.5px] leading-relaxed text-muted-foreground">
        ...
        <span>
          Written by {server.name}, not by Workmates. It runs with no origin of its
