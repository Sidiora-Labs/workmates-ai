...
import { TeamMapView } from "../rooms/TeamMap";
...
export function ActivityPanel() {
  ...
  return (
    ...
    >
      <div
        className={cn(
          "flex h-[80%] max-w-[92vw] animate-pop-in flex-col rounded-[14px] bg-popover/90 p-4 shadow-[0_24px_64px_-12px_var(--shadow-color),0_0_0_0.5px_var(--border),0_0_0_1px_var(--shadow-color)] backdrop-blur-2xl backdrop-saturate-150 sm:p-5",
