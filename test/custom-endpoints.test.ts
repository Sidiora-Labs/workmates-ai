...
import { activeCustomKey, customInstanceId, instanceConfigs, type AppConfig } from "../server/core/config.ts";
import { CUSTOM_SPEC, normalizeCompatUrl } from "../server/integrations/providers.ts";
