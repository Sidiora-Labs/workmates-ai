...
writeFileSync(join(dir, "rooms.json"), JSON.stringify([room], null, 2), { mode: 0o600 });
...
writeFileSync(join(dir, "config.json"), JSON.stringify({ setupDoneAt: base }, null, 2), { mode: 0o600 });
